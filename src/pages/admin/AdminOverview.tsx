    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-5">
        <div className="bg-card border border-border rounded-lg p-6">
          <h2 className="serif text-xl mb-4">Top Items by Clicks</h2>
          <div style={{ width: "100%", height: 280 }}>
            <ResponsiveContainer>
              <BarChart data={data.topItems}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="clicks" fill="hsl(var(--foreground))" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        <div className="bg-card border border-border rounded-lg p-6">
          <h2 className="serif text-xl mb-4">Top Projects by Clicks</h2>
          <div style={{ width: "100%", height: 280 }}>
            <ResponsiveContainer>
