...
export const items: Item[] = [
  {
    ...
    textures: ["Full-Grain Leather", "Brushed Steel", "Hardwood"],
  },
  {
    slug: "barrel-chair",
    name: "Barrel Chair",
  ...
  {
    slug: "tubular-curved-sofa",
    name: "Tubular Curved Sofa",
    code: "UP25127",
    category: "SEATING",
    specs: {
  ...
  {
    slug: "valora-wing-chair",
    name: "Valora Wing Chair",
    code: "UP25121",
    category: "SEATING",
    specs: {
      dimensions: "82 × 84 × 96 cm (W × D × H)",
