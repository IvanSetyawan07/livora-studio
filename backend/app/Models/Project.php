...
class Project extends Model {
    ...
    public array $translatable = ['title','subtitle','description','location'];
    protected $fillable = ['title','slug','subtitle','description','location','year','hero_image','scope_id','is_highlighted','sort_order','hero_focus_x','hero_focus_y','hero_zoom', 'meta_title','meta_description'];
